...
namespace Drupal\blp_flex_groups_project\Access;
 ...
 */
class BlpFlexGroupsProjectJoinPermissionAccessCheck implements AccessInterface {
  ...
  public function access(Route $route, RouteMatchInterface $route_match, AccountInterface $account) {
    $permission = $route->getRequirement('_project_group_join_permission');
    ...
    if ($type instanceof GroupTypeInterface && $type->id() !== 'blp_project') {
