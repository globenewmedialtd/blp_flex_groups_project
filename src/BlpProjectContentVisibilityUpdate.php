...
/**
 * Class BlpProjectContentVisibilityUpdate.
 *
 * @package Drupal\blp_flex_groups_project
 */
class BlpProjectContentVisibilityUpdate {
  ...
  public static function batchUpdateGroupContentVisibility(Group $group, array $changed_visibility, array $new_options) {
    ...
    for ($i = 0; $i < $num_operations; $i++) {
      $operations[] = [
        '\Drupal\blp_flex_groups_project\BlpProjectContentVisibilityUpdate::updateVisibility',
        [
          $entities[$i],
          $new_options,
        ],
    ...
    $batch = [
      ...
      'finished' => '\Drupal\blp_flex_groups_project\BlpProjectContentVisibilityUpdate::updateVisibilityFinishedCallback',
    ];
